...
<div class="display-grid col-12 float-left p-0">
      ...
      <?php $image6 = get_field('image_6'); ?>
        ...
        <?php $image7 = get_field('image_7'); ?>
          ...
          <?php $image8 = get_field('image_8'); ?>
            ...
            <ul class="col-12 <?php the_field('multi-units'); ?> float-left p-0" id="<?php the_field('property-title-selector') ?>">



                      <?php
                      $args = array(
                        'post_type' => 'multi-unit',
            ...
            <?php $image = get_field('main_image'); ?>
              ...
              <li class="<?php the_field('property-location'); ?> col-6 col-md-3 col-lg-2 float-left">
                <a href="<?php the_permalink(); ?>" class="col-12 float-left p-0"><div class="multi-unit-image-container col-12 float-left p-0"><img src="<?php echo $image['url'] ?>" alt="<?php echo $image['alt'] ?>" class="col-12 float-left p-0"></div>
                <p class="col-12 p-0 float-left"><?php the_title(); ?></p></a></li>
